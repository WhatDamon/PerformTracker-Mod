...
public class PerformTracker implements ModInitializer {
	...
	private static ServerTickCollector serverTickCollector;
	private static IFpsProvider fpsProvider;

	@Override
	public void onInitialize() {
		LOGGER.info("PerformTracker initialized.");
		serverTickCollector = new ServerTickCollector();
		trackerController = new TrackerController(serverTickCollector, null);
	...
	public static ServerTickCollector getServerTickCollector() {
		return serverTickCollector;
	}
